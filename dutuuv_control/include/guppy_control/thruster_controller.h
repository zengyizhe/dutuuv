...
// #include "dutuuv_control/VehiclePropertiesConfig.h"
#include "boost/thread/mutex.hpp"
#include <mutex>

#include "dutuuv_msgs/ThrustStamped.h"
// #include "dutuuv_msgs/Imu.h"
#include "dutuuv_msgs/NetLoad.h"
...
class ThrusterController{
    private:
        ...
        dutuuv_msgs::ThrustStamped thrust_msg;
        geometry_msgs::Vector3Stamped cob_msg;

        //Dynamic Reconfigure Setup
        // typedef dynamic_reconfigure::Server<dutuuv_control::VehiclePropertiesConfig> DynamicReconfigServer;
        ...
        std::recursive_mutex param_reconfig_mutex;
        ...
        double solver_forces[4];   //Solved forces go here
    ...
    public:
        ...
        void InitThrustMsg();
        // void DynamicReconfigCallback(dutuuv_control::VehiclePropertiesConfig &config, uint32_t levels);
        // void OdomCB(const nav_msgs::Odometry::ConstPtr &odom_msg);
        void NetLoadCB(const dutuuv_msgs::NetLoad::ConstPtr &netload_msg);
        void Loop();
};
...
class EOM{
    ...
    public:
        EOM(int &numThrust, const Ref<const MatrixXd> &thrustCoeffsIn, double *weightLoadIn, double *transportThmIn, double *commandIn){
