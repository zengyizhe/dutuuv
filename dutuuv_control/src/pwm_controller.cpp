#include "dutuuv_control/pwm_controller.h"
...
PWMController::PWMController() : nh("~"){
    ...
    pwm_pub = nh.advertise<dutuuv_msgs::PwmStamped>("/command/pwm", 1);
...
void PWMController::ThrustCB(const dutuuv_msgs::ThrustStamped::ConstPtr &thrust){
    if(!dead && !reset_pwm){
        pwm_msg.header.stamp = thrust->header.stamp;
        
        pwm_msg.pwm.horizontal_port = Thrust2pwm(thrust->thrust.horizontal_port, thrusterType[thrust->thrust.HP], "HP");
        pwm_msg.pwm.horizontal_stbd = Thrust2pwm(thrust->thrust.horizontal_stbd, thrusterType[thrust->thrust.HS], "HS");

        pwm_msg.pwm.vertical_port = Thrust2pwm(thrust->thrust.vertical_port, thrusterType[thrust->thrust.VP], "VP");
        pwm_msg.pwm.vertical_stbd = Thrust2pwm(thrust->thrust.vertical_stbd, thrusterType[thrust->thrust.VS], "VS");
...
void PWMController::PublishZeroPWM(){
    ...
    pwm_msg.pwm.horizontal_port = NEUTRAL_PWM;
    pwm_msg.pwm.horizontal_stbd = NEUTRAL_PWM;
    pwm_msg.pwm.vertical_port = NEUTRAL_PWM;
    pwm_msg.pwm.vertical_stbd = NEUTRAL_PWM;
